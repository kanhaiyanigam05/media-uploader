function toggleSidebar() {
    ...
    // Change button icon depending on the sidebar state
    if (sidebar.classList.contains("active")) {
        buttonIcon.classList.remove("fa-right-from-bracket"); // Remove the 'exit' icon
        buttonIcon.classList.add("fa-arrow-left-long"); // Add the 'arrow left' icon
    } else {
